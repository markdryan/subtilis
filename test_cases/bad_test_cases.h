...
typedef enum {
	...
	SUBTILIS_TEST_CASE_ID_LOCAL_OBSCURES_GLOBAL_1,
	SUBTILIS_TEST_CASE_ID_LOCAL_OBSCURES_GLOBAL_2,
	SUBTILIS_TEST_CASE_ID_GET_HASH_STRING_ARRAY,
	SUBTILIS_TEST_CASE_ID_PUT_HASH_INT,
